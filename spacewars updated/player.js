// Funktion som ritar ut spelaren enligt dess x och y-värden
...
// Funktion som hanterar player movement
export function playerMovement(game) {

    // Lägger data för spelaren (hämtat från objektet player) i variabeln player
